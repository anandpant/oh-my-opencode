...
| Metis (Plan Consultant) | anthropic/claude-opus-4-5 | Pre-planning analysis |
| Momus (Plan Reviewer) | openai/gpt-5-2 | Plan validation |
...
| general | openai/gpt-5.2-codex (medium) | Balanced general purpose |
